...
export default function ProductsPage() {
  ...
  return (
    <div className='px-4 sm:px-6 lg:px-8'>
      ...
      <div className="mt-4">
        <TableSearch search={search} setSearch={setSearch} placeholder="Search products" />
      </div>
                  ...
                  <td className="max-w-[200px] py-5 pl-4 pr-3 text-sm sm:pl-0">
                    <div className="flex items-center">
                      <div className="h-18 w-18 flex-shrink-0">
                        <img className="h-18 w-18 rounded-full" src={product.thumbnail || "https://dummyjson.com/image/72x72"} alt="product image" />
                      </div>
                      <div className="ml-4">
